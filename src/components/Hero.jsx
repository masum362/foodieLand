...
const Hero = () => {
  return (
    <section className='hero flex gap-4'>
      ...
      <div className='flex-1 flex flex-col md:flex-row m-2 lg:m-0 bg-primaryBackground rounded-3xl overflow-hidden'>
        <div className='w-full  p-6 sm:p-4 lg:p-10 space-y-6'>
          ...
          <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4'>
            <Button className='flex items-center justify-start gap-4 bg-black/5 hover:bg-black/20 duration-150  p-6 rounded-full'>
          ...
          <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 lg:pt-16'>
            ...
            <Button className='flex items-center gap-4 bg-primary p-6 rounded-xl'>
              <p>View Recipe</p>
        ...
        <div className='w-full overflow-hidden'>
          <img src={heroImage} alt="hero" className='w-full max-h-[640px] h-full' />
        </div>
